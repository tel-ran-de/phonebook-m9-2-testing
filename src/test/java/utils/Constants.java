...
public class Constants {
    public static final String SIGN_UP_URL = "http://localhost:4200/user/registration";
    public static final String ACTIVATE_EMAIL_URL = "http://localhost:4200/user/activate-email";
    public static final String LOGIN_URL = "http://localhost:4200/user/login";
    public static final String USER_URL = "http://localhost:4200/";
    ...
    public static final String LONG_PASSWORD = "1234567890123456789012";
